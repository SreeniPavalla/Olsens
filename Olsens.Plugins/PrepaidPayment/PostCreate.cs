...
namespace Olsens.Plugins.PrepaidPayment
{
    ...
    {
        /// <summary>
        /// Triggers on PostCreate of PrepaidPayment
        ...
        protected override void Execute()
        {
            try
            {
                ...
                AppendLog("PrePaidPayment PostCreate - Plugin Excecution is Started.");

                Entity target = (Entity)Context.InputParameters["Target"];

                if ((target == null || target.LogicalName != "ols_prepaidfuneralpayments" || target.Id == Guid.Empty))
                {
                ...
                Guid opportunityId = target.Contains("ols_funeralid") ? target.GetAttributeValue<EntityReference>("ols_funeralid").Id : Guid.Empty;
                ...
                AppendLog("PrePaidPayment PostCreate - Plugin Excecution is Completed.");
            }
            catch (Exception ex)
            {
